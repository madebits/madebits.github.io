...
Difference between the optical zoom and the actual zoom depends on $$$S\_1$$$. If $$$S\_1$$$ is too big (the object is too far away) then $$$\frac{1} {S\_1}$$$ can be approximated to zero, so that $$$S\_2 = f$$$. If $$$S\_1$$$ is small, comparable to $$$S\_2$$$, then $$$S\_2 = 2f$$$. To zoom near objects same as distant ones we need a bigger $$$S\_2$$$. For same $$$f$$$ range near objects have a smaller actual zoom.
